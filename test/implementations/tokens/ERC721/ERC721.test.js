...
const { ERC721Deployer } = require('../../../../helpers/deployers');
...
describe('ERC721', async () => {
  ...
  beforeEach('setup', async () => {
    ...
    erc721 = await new ERC721Deployer().deployProxy(['N', 'S']);
  });

  describe('ERC721_init()', async () => {
    ...
    it('should revert on second initialize', async () => {
      await expect(erc721.proxy.ERC721_init('N', 'S')).to.be.revertedWith(
