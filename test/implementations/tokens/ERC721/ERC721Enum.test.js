...
const { ERC721EnumDeployer } = require('../../../../helpers/deployers');

describe('ERC721Enum', async () => {
  let erc721;
  let owner, ivan;
  ...
  beforeEach('setup', async () => {
    ...
    erc721 = await new ERC721EnumDeployer().deployProxy(['N', 'S']);
  });

  describe('ERC721Enum_init()', async () => {
    ...
    it('should revert on second initialize', async () => {
      await expect(erc721.proxy.ERC721Enum_init('N', 'S')).to.be.revertedWith(
